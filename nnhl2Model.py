...
import mymodels.nnhl2 as nnhl2


""" 
This code implements a neural network with a two hidden layers,
each comprising two neurons.
...
def runtraining(
    ...
    with graph.as_default():
        ...
        # DEFINE GRAPH OPS
        logits_op       = nnhl2.inference( tf_train_dataset )
        loss_op         = nnhl2.loss(      logits_op, tf_train_labels )    
        optimize_op     = nnhl2.training(  loss_op   )
        eval_op         = nnhl2.evaluate(  logits_op )
